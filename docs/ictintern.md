...
![proof-files](./attachments/ictintern-proof-files.png)
![ictintern-proof-portfolio](./attachments/ictintern-proof-portfolio.png)
![ictintern-proof-report](./attachments/ictintern-proof-report.png)

- 구비서류에 적혀있는 모든 서류를 직접 만들었습니다.
  - 인턴하면서 썼던 주차별 보고서랑 자료를 들쳐보며 표지부터 내용까지 채워갔습니다..
  - 개인적인 부분이 많아서 이 서류들은 공유하지 않겠습니다.
- 프로젝트 수행 능력 입증 자료의 설계 파일은 회사 코드는 당연히 공유할 수 없기 때문에 제가 따로 공부하면서 짠 코드, IaC 파일, 실습환경 세팅 파일 등을 모두 첨부했습니다.
  - 공부하면서 만든 것들이라서 간단한 API endpoint 하나 만든 수준이나 기본 설정 파일들이 많았습니다.
- 급여명세서는 은행 사이트에서 발급 받은 `거래내역서`랑 대표님께 부탁드려서 받은 `급여명세서`와 `근로소득 원천징수영수금`을 첨부했습니다.

##### B. PD 교수님께 사인 받기

위 자료들에 추가로 `수료증`까지 첨부해서 PD 교수님께 이메일을 보냅니다.

그러면 PD 교수님께서 날인해주실겁니다.

> PD 교수님을 모르신다면 과사에 연락해보세요!

##### C. 과사에 보내고 연락하기

이후로는 과사에 전화하셔서 진행하시면 됩니다.

과사 이메일로 위의 자료들과 사인 받은 학점 인정서를 보냅니다. (이미 PD 교수님께서 보내주셨을수도 있어요!)
![ictintern-office-email](./attachments/ictintern-swoffice-email.png)

> (참고) 소프트웨어학부 이메일: `caugs55@cau.ac.kr`

마지막으로 확인 부탁드린다고 과사에 연락하세요!
...
:::info 본격 후기글
이 부분은 정보 글은 아니고 개인적인 후기입니다.

[**스킵**](/docs/ictintern#링크)하셔도 됩니다!
:::
